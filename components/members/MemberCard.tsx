    ...
    <Link href={`/profile/${profile.id}`} className="group">
      <div className="brand-panel card-hover flex flex-col items-center gap-3 rounded-[1.5rem] p-5 text-center">
        ...
        {profile.avatar_url ? (
          ...
          <div className="flex size-16 items-center justify-center rounded-full brand-gradient text-lg font-semibold text-primary-foreground shadow-[0_8px_20px_oklch(0.5_0.18_257/0.2)]">
            {initials}
          </div>
        )}
